...
{
    internal class NeoConnessiInstaller
    {
        public static async Task Install(Storage s)
        {
            ...
            await Util.AddCategory(s, "neoconnessi", "safebrowsing", Util.Ita("Navigazione sicura"),
            ...
            await Util.AddCategory(s, "neoconnessi", "screentime", Util.Ita("Screen Time"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "bullying", Util.Ita("Bullismo e cyberbullismo"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "internetatschool", Util.Ita("Internet a scuola"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "geolocalization", Util.Ita("Geolocalizzazione"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "trust", Util.Ita("Fiducia e controllo"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "privacy", Util.Ita("Privacy e impronta digitale"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "phishing", Util.Ita("Phishing"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "fakenews", Util.Ita("Fake news"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "identity", Util.Ita("Identità digitale"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "behavior", Util.Ita("Comportamento in Rete"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "passwords", Util.Ita("Password sicure"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "gaming", Util.Ita("Gaming"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "cookies", Util.Ita("Cookie"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "competences", Util.Ita("Competenze digitali"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "rights", Util.Ita("Diritti e doveri online"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "devices", Util.Ita("Device e tecnologia"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "health", Util.Ita("Salute e benessere digitale"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "revolution", Util.Ita("Rivoluzione tecnologica"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "virtualreality", Util.Ita("Realtà virtuale"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "web", Util.Ita("La Rete e Internet"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "cybersecurity", Util.Ita("Cybersecurity"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "cloud", Util.Ita("Il Cloud"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "socialmedia", Util.Ita("Utilizzo dei Social Media"),
                new CodyMazeBot.StoreModels.Question
                {
            ...
            await Util.AddCategory(s, "neoconnessi", "email", Util.Ita("Utilizzo delle email"),
                new CodyMazeBot.StoreModels.Question
                {
